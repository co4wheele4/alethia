...
- `pagination-edge-cases.e2e-spec.ts` (3 tests): `documents(limit, offset)` boundaries
...
- **`ai-query.resolver.e2e-spec.ts`** was removed **2026-05-06** with the backend migration that dropped AI-query tables.
