...
const ADRS = {
  ...
  'ADR-007': {
    ...
    status: 'ACCEPTED',
    implementation: [
      'docs/adr/ADR-007-claim-semantics-vs-evidence-semantics.md',
      ...
      'aletheia-frontend/app/features/claimReview/components/ClaimReviewView.tsx',
    ],
    tests: [
      'aletheia-frontend/src/graphql/__tests__/graphql-contracts.test.ts',
      'aletheia-frontend/app/features/claimComparison/__tests__/ClaimComparisonView.test.tsx',
      'aletheia-frontend/app/features/claimReview/__tests__/ClaimReviewView.test.tsx',
  ...
  'ADR-035': {
    ...
    status: 'ACCEPTED',
    implementation: [
      'docs/adr/ADR-035-workspace-isolation-rbac.md',
      'aletheia-backend/src/graphql/utils/gql-auth-user.ts',
      'aletheia-backend/src/graphql/resolvers/claim.resolver.ts',
      'aletheia-backend/src/graphql/resolvers/search.resolver.ts',
      'aletheia-backend/src/graphql/resolvers/evidence.resolver.ts',
      'aletheia-backend/src/graphql/resolvers/review-request.resolver.ts',
    ],
    tests: [
      'aletheia-backend/src/graphql/resolvers/search.resolver.spec.ts',
      'aletheia-backend/src/graphql/resolvers/claim.resolver.spec.ts',
      'aletheia-backend/test/e2e/cross-cutting/workspace-isolation-adr035.e2e-spec.ts',
    ],
    enforcement: [
      'scripts/check-adr-governance.cjs',
      'aletheia-backend/src/auth/guards/jwt-auth.guard.ts',
      'aletheia-backend/src/graphql/utils/gql-auth-user.ts',
    ],
  },
  'ADR-036': {
  ...
  'ADR-038': {
    title: 'User Guidance and Blocked State Semantics',
    status: 'ACCEPTED',
    implementation: [
      'docs/adr/ADR-038-user-guidance-blocked-state-semantics.md',
      'docs/product/user-mental-model.md',
      'docs/product/onboarding-principles.md',
      'docs/product/blocked-state-patterns.md',
    ],
    tests: [
      'aletheia-frontend/e2e/adr-038-user-guidance.spec.ts',
      'tests/adr/adrGovernanceCompliance.test.ts',
    ],
    enforcement: ['tools/pr-checks/epistemicGuard.cjs', 'scripts/check-adr-governance.cjs'],
  },
};
